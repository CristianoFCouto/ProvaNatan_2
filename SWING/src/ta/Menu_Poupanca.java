...
public class Menu_Poupanca {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Menu_Poupanca window = new Menu_Poupanca();
	...
	private void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\caioc\\Downloads\\POUPANÇA.png"));
